 ...
 * generated in the com.mycompany.lab1standalone package. 
...
public class ObjectFactory {
    ...
    private final static QName _GetPersonsResponse_QNAME = new QName("http://lab1standalone.mycompany.com/", "getPersonsResponse");
    private final static QName _FindRequest_QNAME = new QName("http://lab1standalone.mycompany.com/", "findRequest");
    private final static QName _GetPersons_QNAME = new QName("http://lab1standalone.mycompany.com/", "getPersons");
    private final static QName _Fields_QNAME = new QName("http://lab1standalone.mycompany.com/", "fields");

    /**
     * Create a new ObjectFactory that can be used to create new instances of schema derived classes for package: com.mycompany.lab1standalone
     * 
     */
     ...
     * 
     */
    @XmlElementDecl(namespace = "http://lab1standalone.mycompany.com/", name = "getPersonsResponse")
     ...
     * 
     */
    @XmlElementDecl(namespace = "http://lab1standalone.mycompany.com/", name = "findRequest")
     ...
     * 
     */
    @XmlElementDecl(namespace = "http://lab1standalone.mycompany.com/", name = "getPersons")
     ...
     * 
     */
    @XmlElementDecl(namespace = "http://lab1standalone.mycompany.com/", name = "fields")
