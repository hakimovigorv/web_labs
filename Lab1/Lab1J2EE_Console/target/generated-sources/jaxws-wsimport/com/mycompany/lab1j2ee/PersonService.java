 ...
 * 
 */
@WebServiceClient(name = "PersonService", targetNamespace = "http://lab1j2ee.mycompany.com/", wsdlLocation = "http://localhost:8080/Lab1J2EE/PersonService?wsdl")
    ...
    extends Service
{
    ...
    private final static QName PERSONSERVICE_QNAME = new QName("http://lab1j2ee.mycompany.com/", "PersonService");

    static {
        URL url = null;
        WebServiceException e = null;
        try {
            url = new URL("http://localhost:8080/Lab1J2EE/PersonService?wsdl");
    ...
    public PersonWebService getPersonWebServicePort() {
        return super.getPort(new QName("http://lab1j2ee.mycompany.com/", "PersonWebServicePort"), PersonWebService.class);
    }
    ...
    public PersonWebService getPersonWebServicePort(WebServiceFeature... features) {
        return super.getPort(new QName("http://lab1j2ee.mycompany.com/", "PersonWebServicePort"), PersonWebService.class, features);
    }
