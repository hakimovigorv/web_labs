 ...
 * 
 */
@WebServiceClient(name = "PersonService", targetNamespace = "http://lab3standalone.mycompany.com/", wsdlLocation = "http://localhost:8080/PersonService?wsdl")
    ...
    extends Service
{
    ...
    private final static QName PERSONSERVICE_QNAME = new QName("http://lab3standalone.mycompany.com/", "PersonService");
