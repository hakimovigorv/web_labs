 ...
 */
package com.mycompany.lab5standalone;
...
public class PersonResource {
    ...
    @PUT
    public String updatePerson(@QueryParam("id") Integer id,@QueryParam("name") String name, @QueryParam("surname") String surname, @QueryParam("age") Integer age, @QueryParam("birthplace") String birthplace, @QueryParam("university") String university){
        Person newPerson = new Person(name, surname, age, birthplace, university);
        PostgreSQLDAO dao = new PostgreSQLDAO();
    ...
    @DELETE 
    public String deletePerson(@QueryParam("id") Integer id){
        PostgreSQLDAO dao = new PostgreSQLDAO();
